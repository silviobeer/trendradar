...
export function HomeLayout({
  ...
  return (
    <>
      <div className="overflow-hidden grid grid-rows-[1fr_auto] grid-cols-[1fr] lg:grid-cols-[min-content_1fr_min-content] flex-1">
        {/* Left sidebar — inline, desktop only */}
        <aside
          data-sidebar="left-inline"
          className="hidden lg:block w-full max-w-[160px] overflow-y-auto border-r border-primary-20 bg-bg-warm-light p-3"
        >
        ...
        <div className="relative flex items-center justify-center overflow-hidden p-4 h-full min-h-0">
          ...
          <button
            ...
            className="lg:hidden absolute left-2 top-1/2 -translate-y-1/2 z-10 bg-white border border-primary-20 rounded-md p-2.5 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
          >
            <svg
          ...
          <button
            ...
            className="lg:hidden absolute right-2 top-1/2 -translate-y-1/2 z-10 bg-white border border-primary-20 rounded-md p-2.5 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
        ...
        <aside
          ...
          className="hidden lg:block w-full max-w-[160px] overflow-y-auto border-l border-primary-20 bg-bg-warm-light p-3"
        >
          <MegatrendSidebar megatrends={megatrends} />
        </aside>

        {/* Row 2: BranchenFilter */}
        <div className="lg:col-span-3 border-t border-primary-20 bg-bg-warm-light px-4 py-2 flex justify-center items-center">
          <BranchenFilter />
        </div>
      </div>
      ...
      {leftOpen && (
        <>
          ...
          <aside
            ...
            className="fixed inset-y-0 left-0 z-50 w-[200px] bg-bg-warm-light shadow-lg p-4 overflow-y-auto"
          >
            <button
              data-action="close"
              aria-label="Sidebar schliessen"
              onClick={() => setLeftOpen(false)}
              className="mb-4 flex items-center justify-end w-full text-primary-60 hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
      ...
      {rightOpen && (
        <>
          ...
          <aside
            ...
            className="fixed inset-y-0 right-0 z-50 w-[200px] bg-bg-warm-light shadow-lg p-4 overflow-y-auto"
          >
            <button
              data-action="close"
              aria-label="Sidebar schliessen"
