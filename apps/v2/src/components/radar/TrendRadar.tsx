...
const COLORS = {
  ringStroke: "var(--color-ring-border)",
  dividerStroke: "var(--color-primary-60)",
  ringLabel: "var(--color-primary-60)",
  segmentLabel: "var(--color-primary)",
  multiBranchFill: "#666",
...
const RINGS = [
  { label: "BEOBACHTEN", rInner: 210, rOuter: 270, fill: "var(--color-ring-beobachten)" },
  { label: "VORBEREITEN", rInner: 130, rOuter: 200, fill: "var(--color-ring-vorbereiten)" },
  { label: "HANDELN", rInner: 60, rOuter: 120, fill: "var(--color-ring-handeln)" },
] as const;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <circle cx={CENTER} cy={CENTER} r={60} fill="var(--color-bg-warm-light)" />
      ...
      <div className="absolute bottom-3 right-3 z-10 flex items-center gap-1">
        <button
          ...
          className="bg-white border border-primary-20 rounded-md px-2 py-1 text-sm shadow-sm disabled:opacity-40 disabled:cursor-not-allowed hover:bg-primary-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
        >
          −
        </button>
        <span className="bg-white border border-primary-20 rounded-md px-2 py-1 text-xs font-medium shadow-sm min-w-[2.5rem] text-center">
        ...
        {zoomIndex > 0 && (
          <button
            ...
            className="bg-white border border-primary-20 rounded-md px-2 py-1 text-xs shadow-sm hover:bg-primary-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
          >
            ↺
          </button>
        )}
